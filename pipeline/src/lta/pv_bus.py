...
class PVBus:
    '''
    Create class to perform API call and download passenger volume by bus
    ...
    def __init__(self, date):
        ...
        self.conf_pvt = util.load_config('lta_pv_bus.yaml')
    ...
    def api_call(self):
        ...
        url_suffix = self.conf_pvt['config_pv_bus']['url_suffix']
    ...
    def download_zip(self,
        ...
        file_name = f'pv_bus_{yyyymmdd}.zip'
    ...
    def unzip_to_incoming(self,
                          ...
                          csv_dir: str):
        '''
        Function unzips the PV Bus file from S3 and stores the csv into S3.
        ...
        try:
            ...
            zip_key = f'{zip_dir}/pv_bus_{yyyymmdd}.zip'
...
if __name__ == "__main__":
    ...
    zip_prefix = 'incoming/pv_bus/zip'
    csv_prefix = 'incoming/pv_bus/csv'
    pv_bus.unzip_to_incoming(zip_prefix, csv_prefix)
